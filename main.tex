...
\vspace{-3mm}
\begin{itemize}
    \item Assisted a startup called Yash in automating 3D texture application using Python and training simple ML models
    \vspace{-3mm}
    \item Taught full-stack development (MERN) to a group of expert students from my college, and machine learning to a group of expert students from colleges in Coimbatore, Tirunelveli, and Madurai
    \vspace{-3mm}
    ...
    \vspace{-3mm}
    \item Secured first positions in Hackathons, Code Debugging, Web Development, and other competitions conducted by colleges in the south, such as Rohini College of Engineering, Thamirabarani Engineering College, and PSN College of Engineering
    \vspace{-3mm}
